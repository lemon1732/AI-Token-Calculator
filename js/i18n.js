const I18n = (() => {
  ...
  const translations = {
    en: {
      ...
      about: "About",
      privacy: "Privacy",
      pricingTableTitle: "AI API Pricing Comparison (2026)",
      thModel: "Model",
      thInput: "Input",
      thOutput: "Output",
      thCacheRead: "Cache Read",
      tableNote: "Prices in USD per 1M tokens. Source: Official websites. Updated May 2026.",
      discountNote: "* DeepSeek V4 Pro: 75% off until 2026/05/31. Original price: $1.74 input, $3.48 output.",
    },
    zh: {
      ...
      about: "关于",
      privacy: "隐私政策",
      pricingTableTitle: "AI API 价格对比 (2026)",
      thModel: "模型",
      thInput: "输入",
      thOutput: "输出",
      thCacheRead: "缓存命中",
      tableNote: "价格单位：美元/百万 token。数据来源：各厂商官网。更新于 2026 年 5 月。",
      discountNote: "* DeepSeek V4 Pro 限时 75% 折扣，截至 2026/05/31。原价：输入 $1.74，输出 $3.48。",
    },
  };
